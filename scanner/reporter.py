...
class ScanReporter:
    ...
    def to_html(data: Dict[str, Any]) -> str:
        ...
        # Build score card HTML separately to avoid nested f-strings
        score_card = ""
        if risk:
            score_card = f"""<div style="background:{score_color}15;border:1px solid {score_color};border-radius:.75rem;padding:1rem 1.25rem;margin-bottom:1.5rem;display:flex;align-items:center;gap:1.25rem;">
